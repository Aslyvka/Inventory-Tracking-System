...
// Add fieldset to Add Employee form
    ...
    <div>
        ...
        <div class="two-cols">
            ...
            <div>
                ...
                <div class="tooltip">
                    ...
                    <input type="text" name="city" id="city" class="city" placeholder=" ex.Welland" tabindex="7">                                          
                </div>
            </div>
        </div>
        ...
        <div class="two-cols">
            <div >
                ...
                <select name="provinceSelect" id="provinceSelect" class="provinceSelect" style="width:260px;" tabindex="8">
        ...
        <div class="two-cols">
            <div >
                ...
                <select name="deptSelect" id="deptSelect" class="deptSelect" style="width:260px;" tabindex="10">
                    ...
                    <option value="Ordering">Ordering and Purchase</option>
            ...
            <div>
                ...
                <div class="tooltip">
                    <span class="tooltiptext">Set Employee Password</span>  
...
processBtn?.addEventListener("click", (e) => {
    ...
    allFieldsets.forEach(fieldset => {        
        ...
        let dept = fieldset.querySelector(".deptSelect");
        ...
        if (firstName.value == "" || lastName.value == "" || email.value == "" || postalCode.value == "") {
            ...
            let newRequest = {
                ...
                employeeCode:`E00${employeeList.length + 1}`,
                gender: gender.value,
